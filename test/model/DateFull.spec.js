...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProcessMakerApi.DateFull();
  });
  ...
  describe('DateFull', function() {
    it('should create an instance of DateFull', function() {
      // uncomment below and update the code to test DateFull
      //var instane = new ProcessMakerApi.DateFull();
      //expect(instance).to.be.a(ProcessMakerApi.DateFull);
    });
